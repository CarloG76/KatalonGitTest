...
WebUI.verifyElementText(findTestObject('Page_MenuCheck/VociMenu/12_li_Bootloaders'), findTestData('BenGenMenu').getValue(
        1, 12), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_MenuCheck/VociMenu/13_li_BENs'), findTestData('BenGenMenu').getValue(1, 13), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_MenuCheck/VociMenu/14_li_Bundle'), findTestData('BenGenMenu').getValue(1, 14), 
    FailureHandling.STOP_ON_FAILURE)
