...
WebUI.waitForElementPresent(findTestObject('Page_Aurora Vision BenGen/a_Aurora Vision Backoffice'), 10)

selfWindowTitle = WebUI.getWindowTitle()

WebUI.verifyEqual(selfWindowTitle, windowTitle)

selfUrl = WebUI.getUrl()

WebUI.verifyEqual(selfUrl, windowURL)
